<script>
  ...
  function handleSubmit(event) {
    ...
    console.log("ภาคเรียน:", term);
    console.log("ชื่อโครงงาน (ภาษาไทย):", project_name_th);
    console.log("ชื่อโครงงาน (ภาษาอังกฤษ):", project_name_en);
    console.log("ชื่อผู้เสนอโครงงาน:", member);
    console.log("อาจารย์ที่ปรึกษาโครงงาน:", adviser.join("\n"));
    console.log("ที่มาและความสำคัญของปัญหา:", project_problem);
